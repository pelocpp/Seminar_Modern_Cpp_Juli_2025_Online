...
namespace BraceInitialization {
    ...
    {
        double dval{ 123.456 };
        int ival{ 123 };   // 2-er Komplement als bin. Darstellung

        // double:  bin. Darstellung: IEEE Format
    ...
    static void test_03()
    {
        ...
        struct Struct obj5 { .m_j = 2 };              // obj2.m_i => 1, obj2.m_j => 2
    ...
    static void test_09()
    {
        ...
        // Alternative: mit einer for-Schleife 0 reinschreiben
