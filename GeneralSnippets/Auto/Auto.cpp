...
namespace Auto_Examples {
    ...
    static void test_01() {
        ...
        auto z1 = 123;  // Type Deduction // Typableitung
       // int  z2 = 123.456;
        auto z3 = 123.456F;
        ...
        auto d = 2.0f;               // float
        auto e = 'A';                // char
        auto f = "hi";               // char const* // kein std::string
        auto g = true;               // bool
    ...
    static std::unordered_map<int, std::string> getFunction() {
    ...
    static void test_02() {
        ...
        std::unordered_map<int, std::string> result2 {
            getFunction()
        };
    }
    ...
    static auto tueWas(bool flag, float f, double d)
    {
        if (flag) {
            return d;
        }
    ...
    //static auto tueNochWas(bool flag, float f, double d) -> double
    //{
    //    if (flag) {
    //        return d;
    //    }
    ...
    static auto tueNochWas(bool flag, T f, U d)  -> decltype (f+d)
    {
        if (flag) {
            return d;
        }
    ...
    void test_seminar()
    {
        auto result = tueNochWas2 ( true, 123, 456);
    }
